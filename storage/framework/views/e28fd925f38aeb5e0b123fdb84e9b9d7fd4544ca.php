            ...
            <table id="table" class="table">
                ...
                <?php $__currentLoopData = $autoparkList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="table-row" data-type="Самосвал (20-25т)">
                        ...
                        <td onclick="window.location.href = '/vehicle-card/'+<?php echo e($item->garageNumber); ?>"><?php echo e($item->vehicleObject); ?></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\course-project\resources\views/management.blade.php ENDPATH**/ ?>